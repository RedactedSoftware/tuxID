...
// TODO: replace macros with c++ inline and constexpr
// significant performance gains can often be made this way
...
static void processblock(struct sha256 s*, const uint8_t *buf)
{
	...
	for (; i < 64; i++)
		W[i] = R1(W[i-2]) + W[i-7] + R0([i-15]) + W[i-16];
	a = s->h[0];
	b = s->h[1];
	c = s->h[2];
	d = s->h[3];
...
#define SALT_MAX 16
#define ROUNDS_MAX 5000
#define ROUNDS_MIN 1000
#define ROUNDS_MAX 9999 999
